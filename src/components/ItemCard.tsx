    ...
    >
      ...
      {item.isPopular && (
        <img 
          ...
          alt="Hot" 
          className="absolute -top-6 -right-6 w-20 h-20 sm:-top-8 sm:-right-8 sm:w-24 sm:h-24 z-40 drop-shadow-[0_0_8px_rgba(255,100,0,0.8)] pointer-events-none animate-pulse" 
        />
      )}
