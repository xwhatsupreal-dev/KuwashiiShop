          ...
          <form onSubmit={handleSubmit} className="flex flex-col h-full overflow-hidden">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full bg-zinc-900 border text-zinc-100 px-3.5 py-2.5 rounded-2xl text-sm focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 transition-all font-display tracking-tight font-medium placeholder-zinc-600 ${
                  ...
                  return (
                    <motion.button whileTap={{ scale: 0.95 }}
                      ...
                      className={`py-2 px-2.5 rounded-lg text-xs font-bold transition-all text-left flex items-center gap-1.5 border cursor-pointer select-none ${
                        isActive
                          ? 'bg-sky-500/15 border-sky-500/80 text-sky-400 font-extrabold shadow-sm shadow-sky-500/5'
            ...
            <div className="mb-4">
              ...
              <select
                ...
                className="w-full bg-zinc-900 border border-white/5 text-zinc-200 px-3 py-2.5 rounded-2xl text-sm focus:outline-none focus:border-sky-500 transition-all cursor-pointer font-display tracking-tight"
              >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              <div>
                ...
                {(category === 'Starter Accounts' || category === 'รหัส ROV' || category === 'ไอดี ROV') ? (
                  ...
                  <input
                    ...
                    className="w-full bg-zinc-900 border border-zinc-850 text-emerald-400 px-3 py-2 rounded-2xl text-sm focus:outline-none focus:border-sky-500 transition-all font-mono font-bold"
                  />
                )}
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-zinc-900 border border-zinc-850 text-zinc-200 px-3 py-2 rounded-2xl text-sm focus:outline-none focus:border-sky-500 transition-all font-mono font-medium placeholder:text-zinc-600"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-zinc-900 border border-zinc-850 text-sky-400 px-3 py-2 rounded-2xl text-sm focus:outline-none focus:border-sky-500 transition-all font-mono font-medium placeholder:text-zinc-600"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-zinc-900 border border-zinc-850 text-zinc-400 line-through px-3 py-2 rounded-2xl text-sm focus:outline-none focus:border-sky-500 transition-all font-mono font-medium placeholder:line-through-none"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-zinc-900 border border-zinc-850 text-zinc-100 px-3 py-2 rounded-2xl text-sm focus:outline-none focus:border-sky-500 transition-all font-mono font-medium"
                />
            ...
            {(() => {
              ...
              if (pCount > 1) {
                return (
                  <div className="bg-sky-500/5 border border-sky-500/20 p-3 rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                    <span className="text-xs text-sky-300 font-medium">💡 คำนวณคลังเสมือนจริง:</span>
                    <span className="text-xs font-mono text-zinc-300">
                      ได้สินค้า <strong className="text-sky-400 font-extrabold">{pCount}</strong> ชิ้นต่อชุด × สต๊อกมี <strong className="text-emerald-400 font-extrabold">{currentQty}</strong> ชุด = จะมีของข้างในรวมทั้งหมด <strong className="text-white text-sm bg-zinc-900 px-2 py-0.5 rounded-md border border-white/5 font-extrabold">{totalItems} ชิ้น</strong>
                    </span>
                  </div>
                );
              }
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full bg-zinc-900 border border-white/5 text-zinc-200 px-3 py-2.5 rounded-2xl text-sm focus:outline-none focus:border-sky-500 transition-all font-display tracking-tight placeholder-zinc-600 resize-none"
              />
            </div>
              ...
              <div className="bg-zinc-900/60 p-4 rounded-2xl border border-zinc-850 space-y-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="https://..."
                    className="w-full bg-transparent border border-white/5 text-zinc-200 px-3 py-2 rounded-2xl text-xs sm:text-sm font-mono focus:outline-none focus:border-sky-500"
                  />
                </div>
                <div>
              ...
              <div className="bg-zinc-900/60 p-4 rounded-2xl border border-zinc-850 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <motion.button whileTap={{ scale: 0.95 }}
                    ...
                    className="flex items-center gap-1 text-xs font-bold text-sky-500 hover:text-sky-400 transition-colors"
                  >
                      ...
                      <div key={reward.id} className="flex flex-col gap-2 p-2 bg-zinc-800 rounded-lg border border-white/5">
                        <div className="flex items-center gap-2">
                          <input
                            ...
                            className="flex-1 bg-transparent border border-white/5 text-zinc-200 px-3 py-2 rounded-lg text-xs focus:outline-none focus:border-sky-500 transition-all font-display tracking-tight"
                          />
                          <input
                            type="color"
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <input
                            ...
                            className="flex-1 bg-transparent border border-white/5 text-zinc-200 px-3 py-1.5 rounded-lg text-xs focus:outline-none focus:border-sky-500 transition-all font-mono"
                          />
                        </div>
              ...
              {imageType === 'url' && (
                <div className="space-y-1.5 animate-fadeIn">
                  <input
                    ...
                    className="w-full bg-transparent border border-zinc-850 text-zinc-100 px-3 py-2 rounded-2xl text-xs focus:outline-none focus:border-sky-500 font-mono"
                  />
                  {imageUrl && (
                  ...
                  <div className="grid grid-cols-3 gap-2.5">
                    {PRESET_IMAGE_SUGGESTIONS.map((preset) => (
                      <motion.button whileTap={{ scale: 0.95 }}
                        ...
                        className="group relative h-16 rounded-lg overflow-hidden border border-white/5 hover:border-sky-500 transition-all text-left flex items-end p-1 cursor-pointer bg-transparent"
                      >
            ...
            <div className="bg-zinc-900/60 p-4 rounded-2xl border border-zinc-850 space-y-3">
              ...
              <textarea
                ...
                className="w-full bg-transparent border border-white/5 text-zinc-200 px-3 py-2 rounded-2xl text-xs sm:text-sm font-mono focus:outline-none focus:border-sky-500 h-24 resize-y"
              />
            </div>
