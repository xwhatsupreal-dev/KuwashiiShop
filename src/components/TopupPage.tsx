        ...
        >
          {angpaoActive && (
            ...
            >
              ...
              <div className="flex flex-col items-center text-center relative z-10">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform shadow-lg shadow-[#ff203a]/5 overflow-hidden">
                  <img src="https://img1.pic.in.th/images/1000120142.jpg" alt="TrueMoney" className="w-full h-full object-cover" />
                </div>
          ...
          {qrActive && (
            ...
            >
              ...
              <div className="flex flex-col items-center text-center relative z-10">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform shadow-lg shadow-emerald-500/5 overflow-hidden">
                  <img src="https://img1.pic.in.th/images/1000120145.png" alt="Bank" className="w-full h-full object-cover" />
                </div>
        ...
        >
          ...
          <div className="flex items-center gap-4 mb-6 sm:mb-8">
            ...
            <h3 className="text-xl sm:text-2xl font-black text-white tracking-tight">
              {topupModalStep === "angpao" ? "สลิป TrueMoney Wallet" : topupModalStep === "bank" ? "แนบสลิปโอนเงินธนาคาร" : ""}
            </h3>
          </div>
          ...
          <div>
             ...
             <button 
               type="submit"
               disabled={isProcessingTopup || ((topupModalStep === "bank" || topupModalStep === "angpao") && !slipFile)}
               className={`w-full ${topupModalStep === "angpao" ? "bg-[#ff203a] hover:bg-[#ff4d63] shadow-[#ff203a]/20" : "bg-emerald-500 hover:bg-emerald-400 shadow-emerald-500/20"} disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold py-3.5 sm:py-4 rounded-xl text-sm sm:text-base flex items-center justify-center gap-2 transition-colors shadow-lg`}
             >
               {isProcessingTopup ? (
                  <div className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin" />
               ) : (
                 <>
                   <Send className="w-5 h-5" /> {topupModalStep === "angpao" ? "ยืนยันสลิป TrueMoney" : topupModalStep === "bank" ? "ยืนยันสลิปธนาคาร" : ""}
                 </>
               )}
             </button>
             </form>
